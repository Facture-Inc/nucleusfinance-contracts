...
/**
 * @title 0Vix USDC Lending [PolygonPOS to PolygonZKEvm]
 */
contract XChain0VixUSDC is
    SERC20,
    NonblockingLzApp,
    AccessControl,
    Pausable,
    ReentrancyGuard
{
    ...
    constructor(
        ...
        SERC20("NucleusFinance 0Vix USDC", "nf0VixUSDC", _asset.decimals())
