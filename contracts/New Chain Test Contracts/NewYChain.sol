    ...
    ReentrancyGuard
{
    ...
    function invest() public nonReentrant whenNotPaused {
    ...
    function withdrawfromVault() public nonReentrant whenNotPaused {
    ...
    function previewRedeemOfContract() public view virtual returns (uint256) {
